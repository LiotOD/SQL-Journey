...
// dans l'ordre on calcule la superficie qu'on divise pour l'avoir en km², ensuite on la converti en un réel ou numeric pour utiliser le round et garder les 2 chiffres après la virgule 
...
limit 5
// En regardant les données on se rend compte que la colonne pop2013 est en varchar, donc on convertit avant de réaliser l'opération de division ensuite limit 5 pou garder les 5 first
