...
select 'There are a total of ' + count_occup +'  '+ occupation +'s.' from 
(select cast(count(occupation) as varchar) as count_occup, lower(occupation) as occupation from occupations group by occupation) as subquery
